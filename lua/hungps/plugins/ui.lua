add("echasnovski/mini.icons", function() require("mini.icons").setup() end)
add("j-hui/fidget.nvim", function() require("fidget").setup({}) end)

add("echasnovski/mini.hipatterns", function()
...
add("echasnovski/mini.statusline", function()
